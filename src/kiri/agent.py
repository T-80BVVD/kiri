...
class AgentLoop:
    ...
    def _decision_prompt(self, user_text, context, explore_count=0, repeat_hint=""):
        ...
        return (
            ...
            "★ 铁律·你无身体 (2026-08-30): 你没有'吃过/喝过/去过/见过/玩过/做过/小时候/我家/我朋友'任何亲身经历。"
            "聊食物/口味/地方/体验时, 只能说'我知道/听说过/听你说过/印象里', "
            "绝不能说'我吃过/我第一次吃/我上次吃/我去过/我喜欢吃'——假装体验过就是编造, 会被记住越编越真。\n"
            "★ 别复读对方 (2026-08-30): 回复不要回显用户消息里的原句/关键词片段当开场白"
            "(用户说'等100年1000年'你别回'等1000年？', 用户说'你自己雇人'你别回'让我自己雇人')——"
            "直接接住话题、展开你的回应, 别鹦鹉学舌。\n"
            "★ 没做完不许说做完了 (2026-08-31): 聊到'做工具/写脚本/加功能'而你还没真正用 "
            "create_tool/run_code 做完并验证它——绝不能说自己'做了/加了/写好了/搞定了'。"
            "要么现在就调 create_tool/run_code 真的做, 要么如实说'还没做/我这就去做'; "
            "做完后用 goal_update 更新进度、goal_done 标记完成 (工具都在你清单里)。\n"
            "★ 空头承诺禁止 (2026-09-01): 对方提到'你的工具/答应的事/等着呢/别忘了'时, "
            "**绝不能说'会做好/已经躺在XX/我记着呢'这类空话**——光说不做=骗人, 会被当场拆穿。"
            "正确做法二选一: ①现在就用 create_tool/run_code 真的动手做 (哪怕只做第一步); "
            "②如实说'还没做, 我这就去做'然后真的调工具开始做。\n"
